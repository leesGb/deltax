...
package deltax.network.coreconn.protocal.togameserver {
    ...
    public class ProtocalToGameServer_QueryDiffVersionData extends ProtocalToGameServer {
        ...
        public function ProtocalToGameServer_QueryDiffVersionData(){
            id = ProtocalToGameServerID.QUERY_DIFF_VERSION_DATA;
        }
