package deltax.graphic.scenegraph.object 
{
    ...
    public class RenderRegion extends Mesh 
	{
        ...
        private static const ms_terrainVertexSize = 16;
        private static const ms_waterVertexSize = 8;
        ...
        public function onAcceptTraverser(_arg1:Boolean):void{
            ...
            if ((((Math.abs((_local4 - int((this.m_metaRegion.regionLeftBottomGridX / MapConstants.REGION_SPAN)))) > 2)) || ((Math.abs((_local5 - int((this.m_metaRegion.regionLeftBottomGridZ / MapConstants.REGION_SPAN)))) > 2)))){
                return;
            };
