package deltax.graphic.render2D.font 
{
    ...
    public class DeltaXFont implements ReferencedObject 
	{
        ...
        public function DeltaXFont(fName:String="")
		{
		 ...
		 * @return 
		 */		
		public function getEdgeSize(fontSize:Number):uint
		{
			return this.getFontTextureInfo(fontSize).fontEdgeSize;
		}
		 ...
		 * @return 
		 */		
		public function getCharWidth(text:String, fontSize:Number, idx:int=0):uint
		{
			return this.getFontTextureInfo(fontSize).getCharInfo(text.charCodeAt(idx)) >>> 24;
		}
		 ...
		 * @return 
		 */		
        private function getFontTextureInfo(fontSize:uint):DeltaXFontInfo
		{
            var fontInfo:DeltaXFontInfo = this.m_textInfos[fontSize];
            if (fontInfo == null)
			{
				fontInfo = new DeltaXFontInfo(fontSize);
                this.m_textInfos[fontSize] = fontInfo;
            }
